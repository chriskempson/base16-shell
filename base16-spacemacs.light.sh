#!/bin/sh
# Base16 Spacemacs - Shell color setup script
...
color_foreground="44/41/55" # Base 02
color_background="f8/f8/f8" # Base 07
color_cursor="44/41/55" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 444155 # forground
  printf $printf_template_custom Ph f8f8f8 # background
  printf $printf_template_custom Pi 444155 # bold color
  printf $printf_template_custom Pj a3a3a3 # selection color
  printf $printf_template_custom Pk 444155 # selected text color
  printf $printf_template_custom Pl 444155 # cursor
