...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg EEFFFF # foreground
  printf $printf_template_custom Ph 263238 # background
  printf $printf_template_custom Pi EEFFFF # bold color
  printf $printf_template_custom Pj 314549 # selection color
  printf $printf_template_custom Pk EEFFFF # selected text color
  printf $printf_template_custom Pl EEFFFF # cursor
