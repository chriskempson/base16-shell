#!/bin/sh
# Base16 Solar Flare - Shell color setup script
...
color_foreground="58/68/75" # Base 02
color_background="F5/F7/FA" # Base 07
color_cursor="58/68/75" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 586875 # forground
  printf $printf_template_custom Ph F5F7FA # background
  printf $printf_template_custom Pi 586875 # bold color
  printf $printf_template_custom Pj A6AFB8 # selection color
  printf $printf_template_custom Pk 586875 # selected text color
  printf $printf_template_custom Pl 586875 # cursor
  printf $printf_template_custom Pm F5F7FA # cursor text
else
